import{At as e,B as t,Jr as n,Ms as r,Oi as i,Ui as a,Vn as o,Wn as s,Yr as c,c as l,do as u,ds as d,fa as f,fo as p,j as m,mn as h,n as g,nt as _,pt as v,tt as ee,ui as y,vn as te,wo as b,ws as x}from"../three.module-BgH6z1r2.js";import"../modulepreload-polyfill-Dxig7UG6.js";import"../OrbitControls-BI3I4k_p.js";/* empty css               */const S={mapSize:1024,near:.5,far:20},C={room:{dimensions:[12,4,10],position:new x(2.5,.5,0)},discoBall:{radius:.25,position:new x(0,-1,0)},volumetric:{coneLength:5,coneRadius:.4},props:{sphere:{radius:1,position:new x(0,2,-2)},box:{size:1,position:new x(0,0,-3)}}},w={rotationSpeed:.4};var T=class{cubeRenderTarget;camera;depthMaterial;config=S;constructor(){this.cubeRenderTarget=new r(this.config.mapSize,{format:f,type:h,minFilter:y,magFilter:y}),this.camera=new v(this.config.near,this.config.far,this.cubeRenderTarget),this.depthMaterial=new p({vertexShader:`
