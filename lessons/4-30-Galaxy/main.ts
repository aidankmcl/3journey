// I skipped to shaders, so I copied the previous galaxy example
...
const generateGalaxy = () =>
{
     ...
     * Material
     */
    console.log(parameters.particleSize)
...
gui.add(parameters, 'particleSize').min(1.0).max(10.0).step(0.05).name("Size of particles").onFinishChange(generateGalaxy);
